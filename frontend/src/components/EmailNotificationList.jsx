                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold">
                      {selectedEmail.type === 'payment_success'
                        ? 'Payment Successful'
                  ...
                  <div className="mb-4">
                    <p className="text-gray-600 mb-2">
                      <strong>Subject:</strong> {selectedEmail.message.split('\n')[0]}
                    </p>
                    <p className="text-gray-600 mb-2">
                    ...
                    {selectedEmail.venue && (
                      <p className="text-gray-600 mb-2">
                        <strong>Venue:</strong> {selectedEmail.venue.name}
                      </p>
                    )}
                  </div>
